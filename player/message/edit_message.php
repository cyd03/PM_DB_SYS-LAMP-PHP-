    ...
    <div class="top-bar">
        ...
        <div class="title">
            <ul class="nav nav-pills nav-fill">
                <li class="nav-item">
                    <a class="nav-link" href="../player.php">首页</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container mt-5">
        <table id="infoTable" class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td>身高(cm)</td>
                    <td><span id="heightCell" contenteditable="true"></span></td>
                </tr>
                <tr>
                    <td>体重(kg)</td>
                    <td><span id="weightCell" contenteditable="true"></span></td>
                </tr>
                <tr>
                    <td>身份</td>
                ...
                <tr>
                    <td>签约日期</td>
                    <td><span id="startCell" contenteditable="flase"></span></td>
                </tr>
                <tr>
                    <td>合同到期日期</td>
                    <td><span id="endCell" contenteditable="flase"></span></td>
                </tr>
                <!-- 添加更多信息行 -->
            </tbody>
        </table>
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            fetch('get_message.php', {
                ...
                document.getElementById('heightCell').textContent = data.height;
                document.getElementById('weightCell').textContent = data.weight;
            }).catch(error => {
        ...
        document.getElementById('saveButton').addEventListener('click', function() {
            ...
            var height = document.getElementById('heightCell').textContent;
            var weight = document.getElementById('weightCell').textContent;
            var id = document.getElementById('ID_CELL').textContent;
            var data = {
                name: name,
                sex: sex,
                email: email,
