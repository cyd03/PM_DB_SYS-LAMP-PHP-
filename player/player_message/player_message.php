    ...
    <div class="top-bar">
        ...
        <div class="title">
            <ul class="nav nav-pills nav-fill">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../player_message/player_message.php">球员信息</a>
                </li>
                <li class="nav-item">
        ...
        <table id="infoTable" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col"><button class="sort-btn" data-column="height">身高(m)</button></th>
                    <th scope="col"><button class="sort-btn" data-column="weight">体重(Kg)</button></th>
