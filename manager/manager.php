    ...
    <div class="top-bar">
        ...
        <div class="title">
            <ul class="nav nav-pills nav-fill">
                <li class="nav-item">
                    <a class="nav-link active" href="manager.php">首页</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../share/message.php">个人信息</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../share/coach_manage.php">教练管理</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../share/player_manage.php">球员管理</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../share/match_compete.php">比赛信息</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../share/user_message.php">用户信息</a>
                </li>
            </ul>
        </div>
        <div class="user-info">
