...
<body>
    ...
    <div class="container mt-5">
        ...
        <table id="infoTable" class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col"><button class="sort-btn" data-column="identity">身份</button></th>
                    <th scope="col"><button class="sort-btn" data-column="status">状态</button></th>
                </tr>
            </thead>
            <tbody>
            </tbody>
        ...
        <div class="text-center">
            <a href="edit_user_manage.php" class="btn btn-primary">修改</a>
        </div>
    </div>
